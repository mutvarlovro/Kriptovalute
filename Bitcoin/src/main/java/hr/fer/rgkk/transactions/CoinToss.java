...
public class CoinToss extends ScriptTransaction {
    ...
    public Script createLockingScript() {
        ...
        return new ScriptBuilder()
                .op(OP_2DUP)        //46-54 3.1. provjera Ra i Rb
                .op(OP_HASH160)
                ...
                .op(OP_EQUALVERIFY)
                .op(OP_SIZE)        //stavi veličinu gornjeg elementa na stog
                .op(OP_NIP)         //makni predzadnji element sa stoga
                .op(OP_16)          //stavi 16 na vrh stoga
                .op(OP_SUB)         //oduzmi 16 od duljine Alicinog nonce
                .op(OP_SWAP)        //zamijeni Bobove nonce i razliku
                .op(OP_SIZE)        //stavi veličinu Bobovog nonce na vrh
                .op(OP_NIP)         //makni Bobov nonce
                .op(OP_16)          //stavi 16 na vrh stoga
                .op(OP_SUB)         //oduzmi 16 od duljine Bobovog nonce
                .op(OP_SUB)         //oduzmi dva N
                .op(OP_0NOTEQUAL)   // 0 ostaje 0, ostalo postaje 1
                .op(OP_IF)          //ako je 1
                .data(bobKey.getPubKey()) //pobijedio je Bob
                .op(OP_ELSE)        //inače
                .data(aliceKey.getPubKey()) //je pobijedila Alice
                .op(OP_ENDIF)
                .op(OP_CHECKSIG)
                .build();
    }
